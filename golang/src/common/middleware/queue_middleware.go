...
func NewQueue(name string, connectionSettings ConnSettings) (*QueueMiddleware, error) {
...
func (qm *QueueMiddleware) StartConsuming(callbackFunc func(msg Message, ack func(), nack func())) (err error) {
...
func (qm *QueueMiddleware) publishToQueue(msg Message) error {
	qm.stateMutex.Lock()
	defer qm.stateMutex.Unlock()
...
func (qm *QueueMiddleware) tryPublish(msg Message, retries int) (err error) {
	_, err = retryWithBackoff(
		retries,
		func() (struct{}, error) {
			placeHolder := struct{}{}
...
func (qm *QueueMiddleware) Send(msg Message) (err error) {
